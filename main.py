...
if __name__ == '__main__':
    ...
    img_height = 180
    img_width = 180
    train_data_dir = "C:/Users/jaral/PycharmProjects/Image_analyses/train"
    ...
    validation_data_dir = "C:/Users/jaral/PycharmProjects/Image_analyses/valid"
    ...
    def roc_curvee():
        ...
        test_path = "C:/Users/jaral/PycharmProjects/Image_analyses/test"
        ...
        # Get saved model
        model_interpreter = tf.lite.Interpreter(model_path="kersas_model.tflite")
        # Optimizes inference
        ...
        for sub_directory in directory_test_list:
            if 'no_tumor' in str(sub_directory):
                tumor = 0
            else:
                tumor = 1
        ...
        auc_score = roc_auc_score(test_dataset_y_values, predictions)
