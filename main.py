...
def pre_processing(training_data, validation_data, class_names,
                   img_height, img_width):
    AUTOTUNE = tf.data.AUTOTUNE

    train_ds = training_data.cache().shuffle(1000).prefetch(
...
def model_training(train_ds, val_ds, num_classes, data_augmentation):
...
if __name__ == '__main__':
    training_data, validation_data, class_names, img_height, img_width = initializing_data()
